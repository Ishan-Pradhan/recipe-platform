...
const SkeletonLoader = () => {
  return (
    <div className="flex h-full w-full animate-pulse flex-col ">
      <div className="h-64 w-full rounded-t-[16px] bg-[#D1D5DB] md:h-64"></div>
      <div className="bg-[#F3F4F6] relative flex h-full flex-col justify-between gap-[40px] rounded-b-[16px] p-[24px]">
        <div className="gap-[12px] flex h-full w-full flex-col justify-between">
        ...
        <div className="flex flex-col gap-[16px] w-full md:flex-row md:items-center md:justify-between">
